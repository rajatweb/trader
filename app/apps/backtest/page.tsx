                ...
                {status === 'idle' && (
                    <div className="flex flex-col items-center justify-center h-full gap-4">
                        ...
                        <p className="text-slate-500 text-sm text-center max-w-md">
                            ...
                            The engine fetches real 5-min data from Dhan and runs the full ADR Sniper strategy logic.
                        </p>
                    </div>
                )}
                ...
                {(status === 'fetching' || status === 'running') && (
                    <div className="flex flex-col items-center justify-center h-full gap-5">
                        ...
                        <div className="w-64 h-2 bg-white/5 rounded-full overflow-hidden border border-white/5">
                            <div className={`h-full transition-all duration-300 rounded-full bg-violet-600`}
                            ...
                            <div className="flex items-center justify-between flex-shrink-0">
                                <div className="flex items-center gap-3">
                                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                                        {instrument === '25' ? 'BANKNIFTY' : 'NIFTY'} · 5 MIN · {activeDay ? activeDay.slice(5) : (activeMonth ? activeMonth : 'ALL')}
                                    </span>
